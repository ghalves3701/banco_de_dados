...
Ferramentas: manuais, eletricas, bateria, epi. 
insumos:isolantes, conectores, terminais,
Produto: id_produto, nome, desc, valor_venda, valor_compra, estoque.
Deposito: id_deposito, nome, endereco, telefone, produtos no deposito, quantidade de produto em estoque
